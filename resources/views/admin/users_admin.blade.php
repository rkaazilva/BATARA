...
<body class="flex min-h-screen">
    ...
    <aside class="sidebar w-64 text-white min-h-screen flex flex-col">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ url('/admin/users') }}" class="nav-item flex items-center px-4 py-3 rounded-lg active">
    ...
    <main class="flex-1 p-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="page-title text-3xl font-bold">Manajemen User</h2>
            <a href="#" class="btn-purple text-white px-5 py-3 rounded-lg font-medium flex items-center">
        ...
        <div class="content-card bg-white p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="md:col-span-2">
                    <div class="relative">
                        <input type="text" placeholder="Cari user..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="content-card bg-white p-6">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left table-header">
                                <span class="text-white font-semibold">BUMDES</span>
                            </th>
                            <th class="px-6 py-4 text-left table-header">
                                <span class="text-white font-semibold">Bergabung</span>
                            </th>
                            <th class="px-6 py-4 text-left table-header">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr class="table-row">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="font-medium text-gray-900">Ahmad Sutisna</div>
                                        <div class="text-gray-500">@ahmads</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">ahmad@email.com</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">12 Jan 2023</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex justify-center space-x-3">
                                    <button class="action-btn text-blue-600 hover:text-blue-800" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="action-btn text-red-600 hover:text-red-800" title="Hapus">
                        ...
                        <tr class="table-row">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="font-medium text-gray-900">Siti Rahayu</div>
                                        <div class="text-gray-500">@sitir</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">siti@bumdesmajujaya.com</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="role-bumdes">
                                    <i class="fas fa-user-shield mr-1"></i> Admin BUMDES
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">BUMDES Maju Jaya</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">15 Feb 2023</div>
                                <div class="text-gray-500">9 bulan lalu</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="status-active">
                                    <i class="fas fa-check-circle mr-1"></i> Aktif
                        ...
                        <tr class="table-row">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-gray-500">@budis</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">budi@email.com</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">20 Mar 2023</div>
                        ...
                        <tr class="table-row">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="font-medium text-gray-900">Dewi Wulandari</div>
                                        <div class="text-gray-500">@dewiw</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">dewi@email.com</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="role-user">
                                    <i class="fas fa-user mr-1"></i> User
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-gray-900">5 Apr 2023</div>
                                <div class="text-gray-500">7 bulan lalu</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="flex items-center justify-between mt-6 px-4">
                <div class="text-sm text-gray-700">
                    Menampilkan 1 sampai 4 dari 42 hasil
                </div>
