...
<body class="flex bg-gray-100 min-h-screen">
    ...
    <aside id="sidebar" class="sidebar w-64 bg-primary text-white min-h-screen p-5">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('bumdes.profil') }}" class="flex items-center py-2 px-4 bg-secondary rounded-md transition">
            ...
            <div class="lg:col-span-2">
                <div class="profile-card bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="bg-gray-50 p-3 rounded-lg">Jl. Desa Raya No. 10, Kecamatan Sukamaju, Kabupaten Sukamakmur, Provinsi Jawa Barat</p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="bg-gray-50 p-3 rounded-lg">BUMDES yang berfokus pada pemberdayaan usaha mikro desa untuk meningkatkan ekonomi masyarakat. Kami membantu para pelaku UMKM untuk mengembangkan usaha mereka melalui platform digital dan pendampingan bisnis.</p>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="profile-card bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <button class="w-full text-left py-2 px-3 hover:bg-gray-50 rounded-lg flex items-center text-red-600">
                ...
                <div class="profile-card bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-sm text-gray-600">BUMDES Anda telah terverifikasi oleh Dinas Koperasi dan UKM Kabupaten Sukamakmur.</p>
                </div>
            </div>
        </div>
